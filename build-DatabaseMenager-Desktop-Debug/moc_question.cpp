...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Question_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Question_t qt_meta_stringdata_Question = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_Question[] = {
...
Q_CONSTINIT const QMetaObject Question::staticMetaObject = { {
    ...
    qt_meta_stringdata_Question.offsetsAndSizes,
...
void *Question::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Crud<Question>"))
        return static_cast< Crud<Question>*>(this);
    if (!strcmp(_clname, "ManyToMany<Tag>"))
        return static_cast< ManyToMany<Tag>*>(this);
